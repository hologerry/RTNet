...
if __name__ == '__main__':
    ...
    #Test data
    tra_image_dir = 'img/'
    datasets = ["../../DataSet/DAVIS/val"]
    DAVIS_dataset = TemporalTestDataset(datasets=datasets, H=384, W=672)
    DAVIS_dataloader = DataLoader(DAVIS_dataset, batch_size=1, shuffle=False, num_workers=2)
